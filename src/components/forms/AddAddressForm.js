                ...
                <div className="form-control">
                    ...
                    <div className="d-flex justify-content-center">
                        <div className="col">
                            ...
                            <input type="text" id="add-name" placeholder="Name" className="form-control  grad-input m-4" onChange={(e) => setAddressName(e.target.value)} />
                            <div className="d-flex justify-content-center">
                            <span id='errName' className="text-danger"></span>
                            </div>

                            <input type="text" id="add-city" placeholder="City" className="form-control   grad-input  m-4" onChange={(e) => setCity(e.target.value)} />
                            <div className="d-flex justify-content-center">
                            <span id='errCity' className="text-danger"></span>
                            </div>

                            <input type="text" id="add-street" placeholder="Street" className="form-control  grad-input m-4" onChange={(e) => setStreet(e.target.value)} />
                            <div className="d-flex justify-content-center">
                            <span id='errStreet' className="text-danger"></span>
                            </div>

                            <input type="number" id="add-pincode" placeholder="Pincode" className="form-control   grad-input m-4" onChange={(e) => setPincode(e.target.value)} />
                            <div className="d-flex justify-content-center">
                            <span id='errPincode' className="text-danger"></span>
                            </div>

                            <textarea type="text"  id="add-address" cols="50" rows="4" placeholder="Address" className=" form-control  grad-input m-4" onChange={(e) => setNewAddress(e.target.value)}></textarea>
                            <div className="d-flex justify-content-center">
